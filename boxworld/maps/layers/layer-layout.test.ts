...
describe("layerLayout", () => {
  it("creates layer with size 1", () => {
    ...
    expect(layer.bounds.origin).toEqual(point2With(1, 1));
  ...
  it("creates layer with larger size", () => {
    ...
    expect(layer.bounds.origin).toEqual(point2With(0, 0));
    expect(layer.bounds.dimensions).toEqual(aabDimensions2With(2, 2));
